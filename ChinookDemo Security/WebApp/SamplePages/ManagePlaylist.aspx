...
<div>
    ...
    <div class="col-sm-2">
        ...
        <asp:DropDownList ID="MediaTypeDDL" runat="server"
            Width="150px" DataSourceID="MediaTypeDLLODS" DataTextField="DisplayText" DataValueField="ValueId">
        </asp:DropDownList><br />
                ...
                <tr style="background-color: #FFFFFF; color: #284775;">
                    <td>
                        <asp:LinkButton ID="AddtoPlaylist" runat="server"
                             CssClass="btn" CommandArgument='<%# Eval("TrackID") %>'><i class="fa fa-plus" style="color:red; font-size:2em;"></i>&nbsp;
