...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <blockquote>This page was used to demo moving a query developed and proven n LinqPad into the web application. </blockquote><br />
    <asp:Label ID="Label1" runat="server" Text="Select your artist"></asp:Label> &nbsp;&nbsp;
    <asp:DropDownList ID="ArtistList" runat="server" DataSourceID="ArtistlistODS" DataTextField="DisplayText" DataValueField="DisplayText"
        AppendDataBoundItems="true">
        <asp:ListItem Value="" Text="Select..."></asp:ListItem></asp:DropDownList>
    ...
    <asp:ObjectDataSource ID="TrackListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Track_FingByArtist" TypeName="ChinookSystem.BLL.TrackController">
